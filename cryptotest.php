...
$PAGE->set_url('/mod/quiz/accessrule/wifiresilience/cryptotest.php');
...
Y.use('node', 'json', 'moodle-quizaccess_wifiresilience-jsencrypt',
        'moodle-quizaccess_wifiresilience-sjcl', function(Y) {
    ...
    Y.one('div.result').append('<h2>Decryption of the data passed back to PHP</h2>' +
            ...
            '/mod/quiz/accessrule/wifiresilience/cryptotest.php?json=' +
...
function decrypt_json($json, $context) {
    ...
    $PAGE->set_context($context);
    $PAGE->set_url('/mod/quiz/accessrule/wifiresilience/cryptotest.php', array('json' => $json));
