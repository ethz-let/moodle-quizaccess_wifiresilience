...
class quizaccess_wifiresilience extends quiz_access_rule_base {
    ...
    public static function add_settings_form_fields(mod_quiz_mod_form $quizform, MoodleQuickForm $mform) {
        ...
        $mform->addElement('text', 'wifiresilience_wifitoken', get_string('wifitoken', 'quizaccess_wifiresilience'), 'size="36"');
        
        $mform->addHelpButton('wifiresilience_wifitoken', 'wifitoken', 'quizaccess_wifiresilience');
    ...
    public function description() {
        ...
        if ($displayadminmsgs == 1) {
            ...
            if (empty($CFG->enablemobilewebservice) || empty($wifisettings->wifitoken) || trim($wifisettings->wifitoken) == '') {
                ...
                $return .= html_writer::start_div('alert alert-error', array('style' => "text-align: left;")) .
                     get_string('webservicedisabled', 'quizaccess_wifiresilience') . html_writer::start_tag('ol');
                
                if (empty($CFG->enablemobilewebservice)) {
                    $return .= html_writer::tag('li', 
                                                get_string('webserviceenablemobile', 'quizaccess_wifiresilience', $CFG->wwwroot));
                }
                ...
                $return .= html_writer::end_tag('ol') . html_writer::end_div('');
            }
        }
        ...
        if ($localresponsesrole == 1) {
            $return .= '<li>' .
                 html_writer::link(
                                new moodle_url('/mod/quiz/accessrule/wifiresilience/local.php', array('id' => $quizcmid)), 
                                get_string('loadlocalresponses', 'quizaccess_wifiresilience')) . '</li>';
            
            $return .= '<li>' .
                 html_writer::link(
                                new moodle_url('/mod/quiz/accessrule/wifiresilience/uploaded_syncedfiles.php', array('id' => $quizcmid)), 
        ...
        if ($displayadminmsgs == 1) {
            $return .= '<hr><h3>' . get_string('serviceworkermgmt', 'quizaccess_wifiresilience') .
                 ...
                 ' id="quizaccess_wifiresilience_reset_sw"> ' . get_string('resetserviceworker', 'quizaccess_wifiresilience') . '</a>
                        <a class="btn btn-warning"  style="display:none;margin-bottom: 5px;"  ' .
                 'id="quizaccess_wifiresilience_update_sw">' . get_string('refreshserviceworker', 'quizaccess_wifiresilience') .
                 '</a> <a class="btn btn-warning"  style="display:none;margin-bottom: 5px;" ' .
                 'id="quizaccess_wifiresilience_stop_sw"> ' . get_string('stopserviceworker', 'quizaccess_wifiresilience') . '</a> ' .
                 '<a class="btn btn-warning"  style="display:none;margin-bottom: 5px;" ' . 'id="quizaccess_wifiresilience_sync_sw"> ' .
